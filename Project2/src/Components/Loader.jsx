...
function Loader(){
    ...
    return (
         ...
         className="screen w-full h-screen flex justify-center items-center" >
         <div className={`sidebar w-[900px] h-[400px] bg-green-300 border rounded-[10px] p-3 absolute z-10 animate-[swipeL_0.6s_ease] ml-[50px]`}></div> 
         <div className={`sidebar w-[900px] h-[350px] bg-blue-500 border rounded-[10px] p-3 absolute z-0 animate-[swipeR_0.6s_ease] ml-[80px]`}></div>   
        <div  className={`w-[900px] min-h-[400px] load scale-100  bg-blue-300  rounded-[10px] p-3 absolute z-20`}>
        <nav className="flex justify-between">   
          <h1 className="text-[30px] font-bold">ochi</h1>
          <Nav id="navbar"/>
        </nav>
            <h1 className="text-[60px] font-bold mt-[50px]">WE CREATE</h1>
            <div className="second flex  items-center ">
            <div className="rect bg-red-400 w-0px rounded-[5px]  h-[50px] leading-[30px]"></div> 
            <h1 className="text-[60px] font-bold leading-[30px]">EYE OPENNING</h1>
            </div>
            <h1 className="text-[60px] font-bold">PRESENTATIONS</h1>
            <div className=" time flex justify-between">
                <p>Loading:</p>
                <h1 className="text-[50px] font-bold">{per}%</h1>
            </div>
            <svg className="sidebox hidden box-content w-[50px] absolute top-[30%] left-[95.6%]">
            ...
            <div className=" hidden foot w-full h-[150px] pt-10" 
            ><Foot  /></div>
        </div>
        </div>
    )
